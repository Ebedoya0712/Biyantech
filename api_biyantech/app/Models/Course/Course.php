        ...
        public function getDiscountCAttribute()
{
    ...
    foreach ($this->discount_courses as $key => $discount_course) {
        // Se añade la verificación: $discount_course->discount && ...
        ...
        public function getDiscountCTAttribute()
{
    date_default_timezone_set("America/Lima");
    $discount = null;
    // Es posible que la categoría no exista, así que también la verificamos
    if (!$this->categorie) {
        return null;
    }
    foreach ($this->categorie->discount_categories as $key => $discount_categorie) {
        // Se añade la verificación: $discount_categorie->discount && ...
